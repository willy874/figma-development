...
| Figma item set variant axes / cell count change                                                                                       | `figma.spec.md` §3.1, re-run `figma-component-sync` to refresh the snapshot                                                                                               |
| Figma wrapper set variant axes / cell count or composition change                                                                     | `figma.spec.md` §3.3, §6.4, re-run `figma-component-sync`                                                                                                                 |
