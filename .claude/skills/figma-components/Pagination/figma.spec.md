...
| Figma item set `1:5098` variant axes / cell count change                                        | `figma.spec.md` §3.1, re-run `figma-component-sync` to refresh the snapshot                                              |
| Figma wrapper set `1:5675` variant axes / cell count or composition change                      | `figma.spec.md` §3.3, §6.6, re-run `figma-component-sync`                                                                |
