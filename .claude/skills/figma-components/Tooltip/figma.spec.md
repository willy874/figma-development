...
7. `.claude/skills/figma-design-guide/design-token.md` — the project token catalogue. If `component/tooltip/fill`'s alpha or hex changes, propagate to §5.3 + §6.1 + §6.2 and re-evaluate divergence #4 in §7.
