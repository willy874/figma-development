...
- The seven palette `*.main` values match the project's `mui/seed/{primary | secondary | danger | warning | info | success}/main` exactly (cross-reference `figma-create-component/library-tokens.md` §1). MUI `error` ↔ MUI `seed/danger`.
